      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Votre partenaire en robotique, systèmes embarqués, automatisme et
              prototypage 3D.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.path}>
                  <Link
                    to={item.path}
                    className="text-gray-500 hover:text-[#143C62] text-sm transition-colors"
                  >
                    {item.label}
                  </Link>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-sm">
            © 2026 Aeris Consulting. Tous droits réservés.
          </p>
          <p className="text-gray-400 text-sm">
            Conçu avec précision par l'équipe Aeris
          </p>
        </div>
      </div>
    </footer>
